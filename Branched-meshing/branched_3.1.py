# -*- coding: utf-8 -*-
"""
Created on Sat May 15 17:21:51 2021
...
"""
x_train_6_1000=np.load(data_dir+'x_train_6_cells_1000_pool_perm.npy', allow_pickle=True)
x_val_6_1000=np.load(data_dir+'x_val_6_cells_1000_pool_perm.npy', allow_pickle=True)
x_test_6_1000=np.load(data_dir+'x_test_6_cells_1000_pool.npy', allow_pickle=True)

x_train_6_1000_label=np.load(data_dir+'x_train_6_cells_1000_pool_labels_cells.npy', allow_pickle=True)
x_val_6_1000_label=np.load(data_dir+'x_val_6_cells_1000_pool_labels_cells.npy', allow_pickle=True)
x_test_6_1000_label=np.load(data_dir+'x_test_6_cells_1000_pool_labels_cells.npy', allow_pickle=True)


x_train_6_1000_TFlabel=np.load(data_dir+'x_train_6_cells_1000_pool_labels_perm.npy', allow_pickle=True)
x_val_6_1000_TFlabel=np.load(data_dir+'x_val_6_cells_1000_pool_labels_perm.npy', allow_pickle=True)
x_test_6_1000_TFlabel=np.load(data_dir+'x_test_6_cells_1000_pool_labels_perm.npy', allow_pickle=True)
"""
...
def sparse_reg(activ_matrix):
    ...
    beta = 1
    epsilon=1e-5
    p_hat = K.backend.abs(K.backend.mean(activ_matrix))+epsilon # average over the batch samples
    print("p_hat = ",p_hat)
...
xA = layers.Dense(512, activation="relu", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(encoderA_inputs)
xA = layers.Dense(64, activation="relu", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xA)
xA = layers.Reshape((n_TFs, n_cells*64), input_shape=(n_TFs, n_cells, 64))(xA)
#xA = layers.Dense(latent_dim, activation="relu", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xA)
zA_mean = layers.Dense(latent_dim, name="zA_mean", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xA)
zA_log_var = layers.Dense(latent_dim, name="zA_log_var", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xA)
zA = Sampling()([zA_mean, zA_log_var])


#Encoder B
encoderB_inputs = full_inputs
xB = layers.Dense(512, activation="relu", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(encoderB_inputs)
xB = layers.Dense(64, activation="relu", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xB)
xB = layers.Reshape((n_cells, n_TFs*64), input_shape=(n_cells, n_TFs, 64))(xB)
#xB = layers.Dense(latent_dim, activation="relu", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xB)
zB_mean = layers.Dense(latent_dim, name="zB_mean", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xB)
zB_log_var = layers.Dense(latent_dim, name="zB_log_var", kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xB)
...
#Decoder C
xC = layers.Dense(64, activation="relu", name='decoder1', kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(y)
xC = layers.Dense(512, activation="relu", name='decoder2', kernel_regularizer=l2(l2_lamda), activity_regularizer=sparse_reg)(xC)
...
tf_latent_1=tf_latent_test[arr, :, :]
tf_latent_1=tf_latent_1.reshape((120, -1))
np.save(data_dir+'branched_3_tf_latent_2.npy', tf_latent_test)
...
np.save(data_dir+'branched_3_cell_latent_2.npy', cell_latent_test)
